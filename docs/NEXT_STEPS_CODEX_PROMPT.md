...
- `AGENTS.md` — operational instructions for Codex or other coding agents.
- `docs/ARCHITECTURE.md` — architecture boundaries, target structure, export rules, storage rules and milestones.
- `docs/NEXT_STEPS_CODEX_PROMPT.md` — recommended prompt for the next Codex task.

Read those files before making significant changes.